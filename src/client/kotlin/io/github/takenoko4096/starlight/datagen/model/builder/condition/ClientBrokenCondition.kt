...
class ClientBrokenCondition(itemModelGenerators: ItemModelGenerators, item: Item, condition: BrokenCondition) : ClientCondition<BrokenCondition, Unit>(itemModelGenerators, item, condition) {
