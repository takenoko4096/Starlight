...
class StarlightEntityTypeTagsProvider internal constructor(val mod: StarlightModInitializer, output: FabricPackOutput, registryLookup: CompletableFuture<HolderLookup.Provider>) : FabricTagsProvider.EntityTypeTagsProvider(output, registryLookup) {
